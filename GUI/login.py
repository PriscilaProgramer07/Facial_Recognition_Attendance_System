...
def validarUsuario(usuario,clave):    
    ...
    """    
    dfusuarios = pd.read_csv(r'C:\Users\Angel\Documents\Programacion\HPC\Streamlit\Web_Page_Login\usuarios.csv')
...
def generarMenu(usuario):
    ...
    with st.sidebar:
        ...
        st.page_link("pages/pagina1.py", label="Face-Recognition", icon=":material/camera:")
        st.page_link("pages/pagina2.py", label="Re-Training", icon=":material/person_add:")
        st.page_link("pages/pagina3.py", label="About", icon=":material/people:")    
